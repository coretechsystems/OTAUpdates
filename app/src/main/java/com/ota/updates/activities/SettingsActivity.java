...
public class SettingsActivity extends PreferenceActivity implements OnPreferenceChangeListener, OnSharedPreferenceChangeListener, Constants{
...
//		String otaPackage = "com.ota.updates";
//		if (preference == mProPreference) {
